...
//                                .splineTo(new Vector2d(-40, 49), Math.toRadians(90))
        ...
        RoadRunnerBotEntity huntysnoSpline = new DefaultBotBuilder(meepMeep)
                // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
//                .setColorScheme(new ColorSchemeRedDark())
                .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15)
                .setDimensions(14, 17)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-59, -35, Math.toRadians(0)))
                                        //CENTER
                                .addTemporalMarker(0, () -> {
                                    //runToAutoSpikePreset();
                                })
                                ...
                                .lineToLinearHeading(new Pose2d(-11, -57, Math.toRadians(90)))
                                .addTemporalMarker(4, () -> {
                                    //startSmartIntake(2);
                                    //claw.setClawClose();
                                })
                                .forward(80)
                                .lineToLinearHeading(new Pose2d(-29, 49, Math.toRadians(90)))
...
//                .setColorScheme(new ColorSchemeRedDark())
                ...
                .followTrajectorySequence(drive ->
                                drive.trajectorySequenceBuilder(new Pose2d(-59, -35, Math.toRadians(0)))
                                        ...
                                        .lineToLinearHeading(new Pose2d(-36, -30, Math.toRadians(55)))
                                        .waitSeconds(0.1)
                                        .addTemporalMarker(1, () -> {
                                            //claw.setClawOpen();
                                            //intakePreset();
                                        ...
                                        .setReversed(true)
                                        .lineToLinearHeading(new Pose2d(-11, -60, Math.toRadians(90)))
                                        .addTemporalMarker(4, () -> {
                                            //startSmartIntake(2);
                                            //claw.setClawClose();
                                        })
                                        ...
                                        .splineTo(new Vector2d(-29, 49), Math.toRadians(90))
                                        .addTemporalMarker(5, () -> {
                                            //relocalization.relocalizeUsingBackdrop(//drive.getPoseEstimate());
                                            //runToAutoBackdropPreset();
                                            //claw.setClawOpen();
                                            //intakePreset();
                                        })
                                        .waitSeconds(2)
        ...
        Image img = null;
        try { img = ImageIO.read(new File("/Users/zhimi/centerstage/MeepMeepTesting/src/main/java/com/example/meepmeeptesting/Juice-CENTERSTAGE-Dark.png")); }
        catch (IOException e) {}
