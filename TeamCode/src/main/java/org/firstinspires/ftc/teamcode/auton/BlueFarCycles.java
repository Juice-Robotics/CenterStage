...
public class BlueFarCycles extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preloadSpikeLeft = drive.trajectorySequenceBuilder(startPose)
                ...
                .waitSeconds(1)
                //stack
                .splineToLinearHeading(new Pose2d(-35, -57, Math.toRadians(-90)), Math.toRadians(-90))
                .waitSeconds(1.5)
                .addTemporalMarker(0, () -> {
        ...
        TrajectorySequence preloadBackdropLeft = drive.trajectorySequenceBuilder(preloadSpikeLeft.end())
                ...
                .splineToSplineHeading(new Pose2d(-44, 51, Math.toRadians(-90)), Math.toRadians(90))
                .addTemporalMarker(0, () -> {
                    this.robot.intake.setAngle(120);
                })
                .addTemporalMarker(2, () -> {
        ...
        TrajectorySequence preloadSpikeCenter = drive.trajectorySequenceBuilder(startPose)
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-36, -34, Math.toRadians(0)), Math.toRadians(0))
                .waitSeconds(1)
