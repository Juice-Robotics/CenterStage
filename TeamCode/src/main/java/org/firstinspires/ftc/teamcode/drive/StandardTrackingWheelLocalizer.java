...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.309; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -1.282; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.001; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.999; // Multiplier in the Y direction
